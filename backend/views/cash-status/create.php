...
<div class="cash-status-create">
	...
	<div class="col-lg-3">
		...
		<div class="form-wrapper">
            ...
            <p><?= number_format($model3->amount - array_sum(ArrayHelper::getColumn(CashStatus::find(['disbursement_amount'])->where(['nca_no'=>$model2->nca])->all(), 'disbursement_amount')), 2) ?></p>
	...
	<div class="col-lg-9">
		...
		<table class="table table-bordered">
            ...
            <tr>
                ...
                <td><label>ORS No.</label></br><?= $model2->ors_class.'-'.$model2->ors_year.'-'.$model2->ors_month.'-'.$model2->ors_serial ?></td>
            </tr>
            <tr>

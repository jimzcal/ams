    ...
    <?php $form = ActiveForm::begin(); ?>
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <td width="150"><?= $form->field($model, 'debit')->textInput(['value' => empty($model->debit) ? $net : $model->debit, 'readonly' => true])->label(false) ?></td>
                    <td width="100">
                        <?= $form->field($model, 'credit_amount')->dropDownList(['0'=>'No Deduction','5'=>'5%', '10'=>'10%', '3'=>'3%'])->label(false)?>
                    </td>
